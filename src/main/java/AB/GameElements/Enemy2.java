...
public class Enemy2 implements Character2 {
    ...
    public Enemy2(GameBoard gameBoard, MenuPanel menuPanel,
                  GamePanel gamePanel, int coordinateX, int coordinateY, int speed){
